...
return new class extends Migration
{
    ...
    {
        Schema::create('medical_supplies_requests', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('user_id'); // BHW who made the request
            $table->string('item_name'); // Name of the medical supply
    ...
    {
        Schema::dropIfExists('medical_supplies_requests');
    }
};
