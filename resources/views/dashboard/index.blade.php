    ...
    <div class="page-content">
        ...
        <div class="content-header">
            <div>
                ...
                <p class="content-subtitle">Monitor health center activities, patient statistics, and program performance at a glance.</p>
            </div>
        </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card stat-card-info">
                ...
                <div class="stat-details">
                    ...
                    <span class="stat-label">{{ $currentMonthName ?? 'Current Month' }}</span>
                </div>
            </div>
