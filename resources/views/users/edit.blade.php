    ...
    <div class="page-content" style="max-width: 1200px; margin: 0 auto;">
        ...
        <div class="form-container">
            <div class="form-header" style="margin-bottom: 20px;">
                <h2 class="form-title" style="font-size: 20px; color: #2c3e50; margin-bottom: 4px;">Edit User Account</h2>
                <p class="form-subtitle" style="color: #7f8c8d; font-size: 13px;">Update user information below</p>
            </div>
