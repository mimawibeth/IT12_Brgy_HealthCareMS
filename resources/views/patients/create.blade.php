...
@section('content')
    <div class="page-content">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('patients.store') }}" class="patient-form">
                @csrf
                ...
                <!-- Non Communicable Disease Category Section -->
                <div class="form-section section-disease">
                    <h3 class="section-header"><span class="section-indicator"></span>Non Communicable Disease Category
                        <small>(Date of registration of disease)</small></h3>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="substance_abuse_date" name="substance_abuse_date" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="at_risk_suicide_date" name="at_risk_suicide_date" class="form-control">
                        </div>
                    </div>
                </div>

                <!-- PhilPen Screening and Disability Assessment Section -->
                <div class="form-section section-screening">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group" style="flex: 1;">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label><input type="checkbox" name="drinks_alcohol" value="1"> Drinks Alcohol</label>
                                </div>
                                <div class="form-group">
                                    <label><input type="checkbox" name="had_5_drinks" value="1"> Had 5 drinks or more in 1
                                        occasion
                                        in a month</label>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label><input type="checkbox" name="dietary_risk_factors" value="1"> Dietary Risk
                                        Factors</label>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="height" name="height" class="form-control" placeholder="cm">
                                </div>
                                <div class="form-group">
                                    <label for="weight">Weight (kg)</label>
                                    <input type="text" id="weight" name="weight" class="form-control" placeholder="kg">
                                </div>
                            </div>
                ...
                <!-- History and Eye Screening Section -->
                        ...
                        <div class="form-group" style="flex: 1;">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="length_diabetes" name="length_diabetes" class="form-control"
                                        placeholder="mos or yrs">
                                </div>
                            </div>
                        ...
                        <div class="form-group" style="flex: 1; margin-left: 20px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-group">
                                        ...
                                        <label><input type="checkbox" name="blurred_vision" value="1"> Blurred
                                            Vision</label>
                                        <label><input type="checkbox" name="fluctuating_vision" value="1"> Fluctuating
                                            Vision</label>
                                        <label><input type="checkbox" name="impaired_color_vision" value="1"> Impaired Color
                                            Vision</label>
                                        <label><input type="checkbox" name="dark_empty_areas" value="1"> Dark/Empty Areas of
                                            Vision</label>
                                        <label><input type="checkbox" name="vision_loss" value="1"> Vision Loss</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <textarea id="ophthalmoscopy_results" name="ophthalmoscopy_results" class="form-control"
                                        rows="2"></textarea>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Initial Visit Assessment Section -->
                <div class="form-section section-assessment">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                        <h3 class="section-header" style="margin: 0;"><span class="section-indicator"></span>Initial Visit
                            Assessment</h3>
                        ...
                        <div class="assessment-entry"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group" style="flex: 1;">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="assessments[0][bp_systolic]" class="form-control"
                                                placeholder="mmHg">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="assessments[0][bp_diastolic]" class="form-control"
                                                placeholder="mmHg">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="assessments[0][lipid_profile]" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="assessments[0][urine_ketones]" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="assessments[0][urine_protein]" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="assessments[0][foot_check]" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" style="flex: 1; margin-left: 20px;">
                                    ...
                                    <p style="font-size: 12px; color: #666; margin-bottom: 15px;">Chief Complaint / History
                                        /
