                        ...
                        <div class="form-section section-patient-info">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="date_registered">Date Registered <span
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="patient_no" name="patient_no" class="form-control"
                                        value="{{ $patientNo ?? '' }}" placeholder="Auto-generated" readonly>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="4ps_cct_id_no">4Ps/CCT (Pantawid Pamilyang Pilipino Program/Conditional Cash
                                        Transfer) ID No.</label>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group" style="flex: 1;">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group">
                                                    <label>Date:</label>
                                                    <input type="date" name="assessments[0][date]"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group">
                                                    <label>Age:</label>
                                                    <input type="text" name="assessments[0][age]"
                                                        class="form-control assessment-age" readonly>
                                                </div>
                                            </div>
