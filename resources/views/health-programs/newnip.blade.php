...
<div class="page-content">
    <div class="content-header">
        <div>
            <h2>New Immunization Records</h2>
            <p class="content-subtitle">
                Track newborn visits, vaccines, and monitoring follow-ups.
            </p>
        </div>
        <div class="header-actions">
            <button class="btn btn-primary" id="openNewNipForm">+ Add New Record</button>
            <button class="btn btn-secondary" id="backToNewNipList" style="display:none;">← Back to List</button>
        </div>
    </div>
    ...
    <div class="form-container" id="newNipFormPanel" style="display:none;">
        ...
        <form id="newNipForm" class="patient-form">
            ...
            <div class="form-section section-patient-info">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="newNip_child_name" name="newNip_child_name" class="form-control" required>
                ...
                <div class="form-row">
                    <div class="form-group full-width">
                        <label for="newNip_address">Complete Purok Address <span class="required-asterisk">*</span></label>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="newNip_mother_name" name="newNip_mother_name" class="form-control" required>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="newNip_birth_order" name="newNip_birth_order" class="form-control" min="1">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section section-history">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="newNip_tt_status_mother">TT status of Mother <span
                                class="required-asterisk">*</span></label>
                        <input type="text" id="newNip_tt_status_mother" name="newNip_tt_status_mother" class="form-control" required>
                        <span class="error-message" data-for="newNip_tt_status_mother"></span>
                    </div>
                    <div class="form-group">
                        <label for="newNip_place_delivery">Place of delivery <span class="required-asterisk">*</span></label>
                        <input type="text" id="newNip_place_delivery" name="newNip_place_delivery" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="newNip_attended_by" name="newNip_attended_by" class="form-control" required>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="newNip_delivery_type">Type of delivery <span class="required-asterisk">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="newNip_initiated_breastfeeding">Initiated breastfeeding after birth <span
                                class="required-asterisk">*</span></label>
                        <select id="newNip_initiated_breastfeeding" name="newNip_initiated_breastfeeding" class="form-control"
                            required>
                            <option value="">Select</option>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="newNip_hearing_test_screened">Screened Hearing Test <span
                                class="required-asterisk">*</span></label>
                        <select id="newNip_hearing_test_screened" name="newNip_hearing_test_screened" class="form-control" required>
                            <option value="">Select</option>
            ...
            <div class="form-actions">
                <button type="button" class="btn btn-primary" onclick="alert('Backend processing not yet implemented')">Save Record</button>
