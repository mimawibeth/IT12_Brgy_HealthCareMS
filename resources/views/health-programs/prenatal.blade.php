...
@section('page-title', 'Prenatal Care - Check Up Form')
    ...
    <div class="page-content">
        <div class="content-header">
            <div>
                ...
                <p class="content-subtitle">Monitor ITR submissions and add new prenatal assessments.</p>
            </div>
        ...
        <div class="form-container wizard-container" id="prenatalFormPanel" style="display:none;">
            ...
            <p class="form-note" style="margin-top:-10px;">Complete each step of the prenatal assessment. Required fields are marked with an asterisk.</p>
            ...
            <div class="wizard-content">
                ...
                <div class="form-row">
                        ...
                        <input type="text" id="occupation" name="occupation" class="form-control">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label><input type="checkbox" id="is_4ps" name="is_4ps" value="1"> 4Ps / NHTS Member</label>
                                </div>
                                <div class="form-group">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                                    ...
                                    <input type="text" id="urinalysis" name="urinalysis" class="form-control" placeholder="Result / Date">
                                </div>
                    </div>
                </div>
                        ...
                        <div class="form-section section-screening">
                            ...
                            <div class="form-row small-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="delivery_count" name="delivery_count" class="form-control" min="0">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="last_delivery_date">Date of Last Delivery</label>
                                    <input type="date" id="last_delivery_date" name="last_delivery_date" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="hemoglobin_first" name="hemoglobin_first" class="form-control" placeholder="g/dL">
                                </div>
                                <div class="form-group">
                                    <label for="hemoglobin_second">2nd Hemoglobin</label>
                                    <input type="text" id="hemoglobin_second" name="hemoglobin_second" class="form-control" placeholder="g/dL">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="blood_type">Blood Typing <span class="required-asterisk">*</span></label>
                                    <input type="text" id="blood_type" name="blood_type" class="form-control" placeholder="e.g., O+" required>
                                </div>
                                <div class="form-group">
                                    <label for="urinalysis_protein">Urinalysis - Protein</label>
                                    <input type="text" id="urinalysis_protein" name="urinalysis_protein" class="form-control">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-section section-history">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="husband_occupation" name="husband_occupation" class="form-control">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="amount_prepared" name="amount_prepared" class="form-control" placeholder="₱">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="wizard-buttons">
                        ...
                        <div class="wizard-nav">
                            ...
                            <button type="submit" class="btn btn-submit" id="prenatalSubmitBtn" style="display:none;">Save Record</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal" id="prenatalViewModal" style="display:none;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-section section-patient-info">
                    <h3 class="section-header"><span class="section-indicator"></span>Mother Info</h3>
                    <div class="form-row">
                        <div class="form-group">
                            <label>Record #</label>
                            <p id="modalRecordId">PT-001</p>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                            <p id="modalMotherName">Maria Dela Cruz</p>
                        </div>
                        <div class="form-group">
                            <label>LMP</label>
                            <p id="modalMotherLmp">2025-01-05</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.view-prenatal').forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    document.getElementById('modalMotherName').textContent = button.closest('tr').children[1].textContent;
                    document.getElementById('modalMotherLmp').textContent = button.closest('tr').children[2].textContent;
