                ...
                <div class="form-section section-patient-info">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="generic_name" name="generic_name" class="form-control" value="{{ old('generic_name', $medicine->generic_name) }}">
                        </div>

                        <div class="form-group">
                            <label for="dosage_form">Dosage Form</label>
                            <input type="text" id="dosage_form" name="dosage_form" class="form-control" value="{{ old('dosage_form', $medicine->dosage_form) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="strength" name="strength" class="form-control" value="{{ old('strength', $medicine->strength) }}">
                        </div>

                        <div class="form-group">
                            <label for="unit">Unit</label>
                            <input type="text" id="unit" name="unit" class="form-control" value="{{ old('unit', $medicine->unit) }}">
                        </div>

                        <div class="form-group">
                            <label for="expiry_date">Expiry Date</label>
                            <input type="date" id="expiry_date" name="expiry_date" class="form-control" value="{{ old('expiry_date', optional($medicine->expiry_date)->toDateString()) }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section section-assessment">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="quantity_on_hand" name="quantity_on_hand" class="form-control" min="0" required value="{{ old('quantity_on_hand', $medicine->quantity_on_hand) }}">
                            <span class="error-message" data-for="quantity_on_hand"></span>
                        </div>

                        <div class="form-group">
                            <label for="reorder_level">Reorder Level</label>
                            <input type="number" id="reorder_level" name="reorder_level" class="form-control" min="0" value="{{ old('reorder_level', $medicine->reorder_level) }}">
                        </div>
                    </div>
